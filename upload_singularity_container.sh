...
singularity sign gcae.sif

# Upload the latest version
singularity push gcae.sif library://richelbilderbeek/default/gcae:0.3

if [[ $HOSTNAME == "N141CU" ]]; then
  notify-send "Done uploading 'gcae.sif'" "Done uploading 'gcae.sif'"
fi
