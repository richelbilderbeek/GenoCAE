...
jobname=ae.$3.$4.$5.$2
#.$8
echo $1 : $2 : $3 : $4 : $5 : $6 : $7 HEJ $8 ABC $9 $test_id DEF $trainedmodeldir
pip3 install docopt grpcio numpy scikit-learn matplotlib\>=3.2.1 seaborn scipy==1.4.1 pandas-plink==2.0.4 pandas==1.0.4 numba tensorflow.probability portpicker 
## Recombination
